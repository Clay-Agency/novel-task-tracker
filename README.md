...
## Pilot onboarding + feedback operations (Issues #30, #41, #230)
Use these docs for pilot participant onboarding, live walkthroughs, structured feedback capture, success evaluation, and weekly synthesis/reporting:
...
- [`docs/pilot/success-metrics.md`](./docs/pilot/success-metrics.md)
- [`docs/pilot/feedback-synthesis-rubric.md`](./docs/pilot/feedback-synthesis-rubric.md)
- [`docs/pilot/feedback-synthesis-template.md`](./docs/pilot/feedback-synthesis-template.md)
- [`docs/pilot/pilot-result-template.md`](./docs/pilot/pilot-result-template.md)
